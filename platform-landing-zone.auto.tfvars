...
custom_replacements = {
  ...
  */
  names = {
    ...
    primary_private_dns_zones_enabled                                    = true # Set to false as we are not using private DNS zones by default we will toggle this below under private DNS zones

...
custom_replacements = {
  ...
  */
  names = {
    ...
    primary_private_dns_zones_enabled                                    = false # Set to false as we are not using private DNS zones by default we will toggle this below under private DNS zones
    ...
    primary_firewall_management_subnet_address_prefix  = "172.0.0.192/26"
